...
* Follow the guide to install the MinGW-w64 toolchain via MSYS2: https://code.visualstudio.com/docs/cpp/config-mingw

**Mac**: `brew install cmake && brew install gcc` Add to Path  
...
* **Update Your Library**: 
  * Bump version in `README.md`, `CHANGELOG.md`, `CMakeLists.txt`
